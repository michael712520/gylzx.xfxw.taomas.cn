            ...
            <table width="400" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                  <td valign="top" style="padding-left:10px">
                    <!-- <?php $_from = $this->_var['brand_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('key', 'brand_list_0_87169400_1465869648');if (count($_from)):
    foreach ($_from AS $this->_var['key'] => $this->_var['brand_list_0_87169400_1465869648']):
?> -->
                    <!-- <?php if ($this->_var['brand_list_0_87169400_1465869648']['name_p'] >= "a" && $this->_var['brand_list_0_87169400_1465869648']['name_p'] <= "g"): ?> -->
                    <div id="@<?php echo $this->_var['key']; ?>"><div id="<?php echo $this->_var['brand_list_0_87169400_1465869648']['name_pinyin']; ?><?php echo $this->_var['brand_list_0_87169400_1465869648']['name']; ?>"><a href="javascript:go_brand_id(<?php echo $this->_var['key']; ?>,'<?php echo $this->_var['brand_list_0_87169400_1465869648']['name']; ?>')"><?php echo $this->_var['brand_list_0_87169400_1465869648']['name']; ?></a></div></div>
                    <!-- <?php endif; ?> -->
    ...
    foreach ($_from AS $this->_var['key'] => $this->_var['brand_list_0_87169400_1465869648']):
?> -->
                    <!-- <?php if ($this->_var['brand_list_0_87169400_1465869648']['name_p'] >= "h" && $this->_var['brand_list_0_87169400_1465869648']['name_p'] <= "k"): ?> -->
                    <div id="@<?php echo $this->_var['key']; ?>"><div id="<?php echo $this->_var['brand_list_0_87169400_1465869648']['name_pinyin']; ?><?php echo $this->_var['brand_list_0_87169400_1465869648']['name']; ?>"><a href="javascript:go_brand_id(<?php echo $this->_var['key']; ?>,'<?php echo $this->_var['brand_list_0_87169400_1465869648']['name']; ?>')"><?php echo $this->_var['brand_list_0_87169400_1465869648']['name']; ?></a></div></div>
                    <!-- <?php endif; ?> -->
                    <!-- <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?> -->
                  </td>
    ...
    foreach ($_from AS $this->_var['key'] => $this->_var['brand_list_0_87169400_1465869648']):
?> -->
                    <!-- <?php if ($this->_var['brand_list_0_87169400_1465869648']['name_p'] >= "l" && $this->_var['brand_list_0_87169400_1465869648']['name_p'] <= "s"): ?> -->
                    <div id="@<?php echo $this->_var['key']; ?>"><div id="<?php echo $this->_var['brand_list_0_87169400_1465869648']['name_pinyin']; ?><?php echo $this->_var['brand_list_0_87169400_1465869648']['name']; ?>"><a href="javascript:go_brand_id(<?php echo $this->_var['key']; ?>,'<?php echo $this->_var['brand_list_0_87169400_1465869648']['name']; ?>')"><?php echo $this->_var['brand_list_0_87169400_1465869648']['name']; ?></a></div></div>
                    <!-- <?php endif; ?> -->
                    <!-- <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?> -->
                  </td>
    ...
    foreach ($_from AS $this->_var['key'] => $this->_var['brand_list_0_87169400_1465869648']):
?> -->
                    <!-- <?php if ($this->_var['brand_list_0_87169400_1465869648']['name_p'] >= "t" && $this->_var['brand_list_0_87169400_1465869648']['name_p'] <= "z"): ?> -->
                    <div id="@<?php echo $this->_var['key']; ?>"><div id="<?php echo $this->_var['brand_list_0_87169400_1465869648']['name_pinyin']; ?><?php echo $this->_var['brand_list_0_87169400_1465869648']['name']; ?>"><a href="javascript:go_brand_id(<?php echo $this->_var['key']; ?>,'<?php echo $this->_var['brand_list_0_87169400_1465869648']['name']; ?>')"><?php echo $this->_var['brand_list_0_87169400_1465869648']['name']; ?></a></div></div>
                    <!-- <?php endif; ?> -->
                    <!-- <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?> -->
                  </td>
    ...
    foreach ($_from AS $this->_var['key'] => $this->_var['brand_list_0_87169400_1465869648']):
?> -->
                    <!-- <?php if ($this->_var['brand_list_0_87169400_1465869648']['name_p'] >= "0" && $this->_var['brand_list_0_87169400_1465869648']['name_p'] <= "9"): ?> -->
                    <div id="@<?php echo $this->_var['key']; ?>"><div id="<?php echo $this->_var['brand_list_0_87169400_1465869648']['name_pinyin']; ?><?php echo $this->_var['brand_list_0_87169400_1465869648']['name']; ?>"><a href="javascript:go_brand_id(<?php echo $this->_var['key']; ?>,'<?php echo $this->_var['brand_list_0_87169400_1465869648']['name']; ?>')"><?php echo $this->_var['brand_list_0_87169400_1465869648']['name']; ?></a></div></div>
                    <!-- <?php endif; ?> -->
                    <!-- <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?> -->
                  </td>
...
<!--            <td><input type="text" name="goods_number" value="<?php echo $this->_var['goods']['goods_number']; ?>" size="20" <?php if ($this->_var['code'] != '' || $this->_var['goods']['_attribute'] != ''): ?>readonly="readonly"<?php endif; ?> /><br />-->
            ...
            -->
              ...
              <td><input type="text" name="goods_number" value="<?php echo $this->_var['goods']['goods_number']; ?>" size="20" <?php if ($this->_var['goods']['goods_type'] != 0): ?> style="color: #666" readonly <?php endif; ?> /><br />
