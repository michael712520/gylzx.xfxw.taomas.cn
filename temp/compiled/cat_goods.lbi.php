...
?>
			<a href="<?php echo $this->_var['ad']['url']; ?>" target="_blank" class="banner-ad">
				<img src="<?php echo $this->_var['ad']['image']; ?>" alt="" height="100" width="1210">
			</a>
...
?>
                            	<li>
                                	<a href="<?php echo $this->_var['ad']['url']; ?>" target="_blank"><img src="<?php echo $this->_var['ad']['image']; ?>" width="270" height="475" /></a>
                                </li>
                            <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
                            </ul>
                        </div>
						...
						<ul class="floor-words">
	    					...
	    					?>
							<?php $_from = $this->_var['child_cat_hot']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'cat_0_59880600_1477367972');$this->_foreach['name1'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['name1']['total'] > 0):
    foreach ($_from AS $this->_var['cat_0_59880600_1477367972']):
        $this->_foreach['name1']['iteration']++;
?>
							<?php $_from = $this->_var['cat_0_59880600_1477367972']['child']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'cat_child');$this->_foreach['name'] = array('total' => count($_from), 'iteration' => 0);
...
?>
                    ...
                    <div class="floor-right">
							...
							<div class="floor-tabs-panel" style="border-top: 1px <?php echo $this->_var['ext_info']['cat_color']; ?> solid;">
								...
								?>
								<?php $_from = $this->_var['best_goods']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'goods_0_59880600_1477367972');$this->_foreach['cat_item_goods'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['cat_item_goods']['total'] > 0):
    foreach ($_from AS $this->_var['goods_0_59880600_1477367972']):
        $this->_foreach['cat_item_goods']['iteration']++;
?>
								<div class="goods" id="li_<?php echo $this->_var['goods_0_59880600_1477367972']['id']; ?>" <?php if ($this->_foreach['cat_item_goods']['iteration'] % 4 == 0): ?>style="width: 234px"<?php endif; ?>>
									<div class="wrap">
										<a target="_blank" href="<?php echo $this->_var['goods_0_59880600_1477367972']['url']; ?>" title="<?php echo htmlspecialchars($this->_var['goods_0_59880600_1477367972']['name']); ?>">
											<img src="<?php echo $this->_var['goods_0_59880600_1477367972']['thumb']; ?>" alt="<?php echo htmlspecialchars($this->_var['goods_0_59880600_1477367972']['name']); ?>" height="140" width="140" class="pic_img_<?php echo $this->_var['goods_0_59880600_1477367972']['id']; ?>">
										</a>
										<p class="title">
											<a target="_blank" href="<?php echo $this->_var['goods_0_59880600_1477367972']['url']; ?>" title="<?php echo htmlspecialchars($this->_var['goods_0_59880600_1477367972']['name']); ?>"><?php echo $this->_var['goods_0_59880600_1477367972']['short_style_name']; ?></a>
										</p>
										<p class="price">
											<span>
												<?php if ($this->_var['goods_0_59880600_1477367972']['promote_price'] != ""): ?>
												<?php echo $this->_var['goods_0_59880600_1477367972']['promote_price']; ?>
												<?php else: ?>
												<?php echo $this->_var['goods_0_59880600_1477367972']['shop_price']; ?>
												<?php endif; ?>
											</span>
										</p>
										<a class="add-cart" onclick="addToCart(<?php echo $this->_var['goods_0_59880600_1477367972']['id']; ?>)" title="加入购物车"></a>
									</div>
								</div>
								<?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
							</div>
...
?>
							...
							<div class="floor-tabs-panel floor-tabs-hide" style="border-top: 1px <?php echo $this->_var['ext_info']['cat_color']; ?> solid;">
								...
								<ul>
									...
									?>
									<?php $_from = $this->_var['new_goods']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'goods_0_59980600_1477367972');$this->_foreach['goods'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['goods']['total'] > 0):
    foreach ($_from AS $this->_var['goods_0_59980600_1477367972']):
        $this->_foreach['goods']['iteration']++;
?>
									<div class="goods" id="li_<?php echo $this->_var['goods_0_59980600_1477367972']['id']; ?>" <?php if ($this->_foreach['goods']['iteration'] % 4 == 0): ?>style="width: 234px"<?php endif; ?>>
										<div class="wrap">
											<a target="_blank" href="<?php echo $this->_var['goods_0_59980600_1477367972']['url']; ?>" title="<?php echo htmlspecialchars($this->_var['goods_0_59980600_1477367972']['name']); ?>">
												<img src="<?php echo $this->_var['goods_0_59980600_1477367972']['thumb']; ?>" alt="<?php echo htmlspecialchars($this->_var['goods_0_59980600_1477367972']['name']); ?>" height="140" width="140" class="pic_img_<?php echo $this->_var['goods_0_59980600_1477367972']['id']; ?>">
											</a>
											<p class="title">
												<a target="_blank" href="<?php echo $this->_var['goods_0_59980600_1477367972']['url']; ?>" title="<?php echo htmlspecialchars($this->_var['goods_0_59980600_1477367972']['name']); ?>"><?php echo $this->_var['goods_0_59980600_1477367972']['short_style_name']; ?></a>
											</p>
											<p class="price">
												<span class="j_CurPrice">
													<?php if ($this->_var['goods_0_59980600_1477367972']['promote_price'] != ""): ?>
													<?php echo $this->_var['goods_0_59980600_1477367972']['promote_price']; ?>
													<?php else: ?>
													<?php echo $this->_var['goods_0_59980600_1477367972']['shop_price']; ?>
													<?php endif; ?>
												</span>
											</p>
											<a class="add-cart" onclick="addToCart(<?php echo $this->_var['goods_0_59980600_1477367972']['id']; ?>)" title="加入购物车"></a>
										</div>
									</div>
									<?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
								</ul>
