        ...
        <div class="item order-item">
            ...
            <div class="item-bd item-bd3">
                <ul class="clearfix">
                    ...
                    <li>
                        <strong><a href="back.php?act=back_list&back_type=4&order_type=2"><?php echo $this->_var['lang']['new_reimburse']; ?></a></strong>
                        <span><?php echo $this->_var['order']['new_repay']; ?> 笔</span>
                    </li>
                    <li class="li_even">
                        <strong><a href="back.php?act=back_list&back_type=1&order_type=2">退货申请</a></strong>
...
<table cellspacing='1' cellpadding='3'>
  ...
  <tr>
    ...
    <td id="php_ver"><?php echo $this->_var['sys_info']['php_ver']; ?></td>
    <td><?php echo $this->_var['lang']['mysql_version']; ?></td>
    <td id="mysql_ver"><?php echo $this->_var['sys_info']['mysql_ver']; ?></td>
  </tr>
  <tr>
    <td>产品最新版本:</td>
    <td id="pro_ver"><?php echo $this->_var['sys_info']['safe_mode']; ?></td>
    <td>当前版本:</td>
    <td id="ver"><?php echo $this->_var['sys_info']['safe_mode_gid']; ?></td>
  </tr>
  <tr>
    <td><?php echo $this->_var['lang']['ec_charset']; ?></td>
    <td id="charset"><?php echo $this->_var['ecs_charset']; ?></td>
    <td></td>
    <td></td>
  </tr>
</table>
