...
a{font-family:"微软雅黑";}
#logo-div {
  height: 68px; width:355px;   float: left;
}
...
<li class="show_8"><a href="http://www.68ecshop.com/ecshop_school.html" target="_blank"><?php echo $this->_var['lang']['help']; ?></a></li>
...
<li class="show_11"><a onclick="clear_cache_mobile()"   target="main_frame">手机缓存</a></li>
<li class="show_4"><a onclick="clear_cache()"  target="main_frame"><?php echo $this->_var['lang']['clear_cache']; ?></a></li>
<li class="show_4"><a onclick="clear_html()"   target="main_frame">更新全部静态</a></li>
<li class="show_4"><a onclick="clear_index()"  target="main_frame">更新首页静态</a></li>
...
function clear_cache(){
	  Ajax.call('index.php?act=clear_cache','', clear_cache_Response, 'GET', 'text');
}
function clear_cache_Response(result){
	if(result==1){
		alert("清除成功！");
	}else{
		alert("清除失败！");
...
function clear_cache_mobile(){
	  Ajax.call('index.php?act=clear_cache_mobile','', clear_cache_mobile_Response, 'GET', 'text');
}
function clear_cache_mobile_Response(result){
	if(result==1){
		alert("清除成功！");
	}else{
		alert("清除失败！");
...
function clear_html(){
	  Ajax.call('index.php?act=clear_html','', clear_html_Response, 'GET', 'text');
}
function clear_html_Response(result){
	if(result==1){
		alert("清除成功！");
	}else{
		alert("清除失败！");
...
function clear_index(){
	  Ajax.call('index.php?act=clear_index','', clear_index_Response, 'GET', 'text');
}
function clear_index_Response(result){
	if(result==1){
		alert("清除成功！");
	}else{
		alert("清除失败！");
